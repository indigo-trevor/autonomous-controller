    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div15 = element("div");
    			p6 = element("p");
    			p6.textContent = "14:23";
    			attr_dev(p0, "class", "footer-item__title svelte-76ed9n");
    			add_location(p0, file$1, 12, 12, 682);
    			attr_dev(div0, "class", "footer-item svelte-76ed9n");
    			add_location(div0, file$1, 11, 8, 644);
    			attr_dev(p1, "class", "footer-item__title footer-item__title--left svelte-76ed9n");
    			add_location(p1, file$1, 15, 12, 806);
    			attr_dev(div1, "class", "icon-container icon-container--close svelte-76ed9n");
    			add_location(div1, file$1, 16, 12, 882);
    			attr_dev(div2, "class", "footer-item footer-item--large svelte-76ed9n");
    			add_location(div2, file$1, 14, 8, 749);
    			attr_dev(div3, "class", "icon-container icon-container--command svelte-76ed9n");
    			add_location(div3, file$1, 21, 12, 1072);
    			attr_dev(p2, "class", "footer-item__title footer-item__title--right svelte-76ed9n");
    			add_location(p2, file$1, 24, 12, 1197);
    			attr_dev(div4, "class", "footer-item footer-item--large svelte-76ed9n");
    			add_location(div4, file$1, 20, 8, 1015);
    			attr_dev(div5, "class", "icon-container icon-container--wifi svelte-76ed9n");
    			add_location(div5, file$1, 27, 12, 1365);
    			attr_dev(div6, "class", "footer-item footer-item--large footer-item--icon-only svelte-76ed9n");
    			add_location(div6, file$1, 26, 8, 1285);
    			attr_dev(div7, "class", "icon-container icon-container--cell svelte-76ed9n");
    			add_location(div7, file$1, 32, 12, 1552);
    			attr_dev(p3, "class", "footer-item__title footer-item__title--right svelte-76ed9n");
    			add_location(p3, file$1, 35, 12, 1676);
    			attr_dev(div8, "class", "footer-item footer-item--large svelte-76ed9n");
    			add_location(div8, file$1, 31, 8, 1495);
    			attr_dev(div9, "class", "icon-container icon-container--wifi svelte-76ed9n");
    			add_location(div9, file$1, 38, 12, 1844);
    			attr_dev(div10, "class", "footer-item footer-item--large footer-item--icon-only svelte-76ed9n");
    			add_location(div10, file$1, 37, 8, 1764);
    			attr_dev(div11, "class", "icon-container icon-container--battery svelte-76ed9n");
    			add_location(div11, file$1, 43, 12, 2040);
    			attr_dev(p4, "class", "footer-item__title footer-item__title--right svelte-76ed9n");
    			add_location(p4, file$1, 46, 12, 2165);
    			attr_dev(div12, "class", "footer-item footer-item--large svelte-76ed9n");
    			add_location(div12, file$1, 42, 8, 1983);
    			attr_dev(div13, "class", "icon-container icon-container--wifi-gps svelte-76ed9n");
    			add_location(div13, file$1, 49, 12, 2310);
    			attr_dev(p5, "class", "footer-item__title footer-item__title--right svelte-76ed9n");
    			add_location(p5, file$1, 52, 12, 2440);
    			attr_dev(div14, "class", "footer-item footer-item--large svelte-76ed9n");
    			add_location(div14, file$1, 48, 8, 2253);
    			attr_dev(p6, "class", "footer-item__title svelte-76ed9n");
    			add_location(p6, file$1, 55, 12, 2565);
    			attr_dev(div15, "class", "footer-item svelte-76ed9n");
    			add_location(div15, file$1, 54, 8, 2527);
    			attr_dev(div16, "class", "content-container svelte-76ed9n");
    			add_location(div16, file$1, 10, 4, 604);
    			attr_dev(div17, "class", "container container--footer svelte-76ed9n");
    			add_location(div17, file$1, 9, 0, 558);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
